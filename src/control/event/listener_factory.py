...
def listener_factory(channel: EVENT_CHANNELS, trigger_action: MessageHandler) -> TelegramController:
    channels = {
    ...
    return _setup_listener(channels[channel], trigger_action)


def _setup_listener(channel: str, trigger_action: MessageHandler) -> TelegramController:
    telegram_kwargs = {
